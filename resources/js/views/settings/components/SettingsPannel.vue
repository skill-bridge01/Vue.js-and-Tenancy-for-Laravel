...
<template>
    <div class="sm:flex justify-between items-center gap-10">
        <CompanyInfo />
        <Form
            @submit="onSubmit"
            ...
            <div class="flex flex-wrap gap-14 pt-9">
                ...
                <div class="flex flex-col gap-6">
                    <div class="text-right">
                        ...
                        <div
                            class="flex flex-col border rounded-lg border-[#ECF1F4] pl-6 pr-4 py-2 bg-white mt-3"
                        >
                            <input
                                id="email"
                                type="email"
                                ...
                                class="text-right font-readex text-base border-none outline-none focus:outline-none"
                                disabled
                                :value="user?.email"
                            />
                        </div>
