...
const emits = defineEmits(["handleClickPiece"]);
...
<template>
    ...
    >
        <!-- <img
            :class="
                selectedPiece?.id === props.piece?.id
                    ? 'selected-image'
                    : 'unselected-image'
            "
        ...
        <img
            :src="props.piece.image?
                ...
                subDomain +
                `/app/public/` +
                props.piece.image:`/images/home/trousers.svg`
            "
            alt=""
        />
        <span
            :class="selectedPiece?.id === props.piece?.id ? 'text-main' : ''"
            class="widget-label"
            >{{ props.piece.piece_title }}</span
        >
    </WidgetButton>
</template>
