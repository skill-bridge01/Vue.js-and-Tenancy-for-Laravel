...
<template>
    <div class="relative text-gray-600 search-bar mx-3 sm:flex hidden border border-gray-300 rounded-full">
        <input 
            class="bg-purple-50 h-10 px-5 pr-10 rounded-full text-sm focus:outline-none text-right border-none focus:shadow-none search-input min-w-[300px]" 
            type="search" 
            name="search" 
            :placeholder="t('dashboard.searchInvoice')"
        />
