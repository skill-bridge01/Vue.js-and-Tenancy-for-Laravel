...
<template>
  <div class="mb-[0.125rem] min-h-[1.5rem] pl-[1.5rem] w-fit flex items-center">
    ...
    <input
      class="
        ...
        before:content-[''] 
        checked:border-brand_blue 
        checked:bg-brand_blue 
        ...
        dark:checked:border-brand_blue 
        dark:checked:bg-brand_blue 
